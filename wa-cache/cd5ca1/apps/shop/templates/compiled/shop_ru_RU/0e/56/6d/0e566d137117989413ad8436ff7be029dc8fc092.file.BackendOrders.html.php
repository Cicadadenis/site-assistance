<?php /* Smarty version Smarty-3.1.14, created on 2026-04-01 18:02:11
         compiled from "/var/www/web-magaz/wa-apps/shop/templates/actions/backend/BackendOrders.html" */ ?>
<?php /*%%SmartyHeaderCode:191555955869cd5da3797663-73222960%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0e566d137117989413ad8436ff7be029dc8fc092' => 
    array (
      0 => '/var/www/web-magaz/wa-apps/shop/templates/actions/backend/BackendOrders.html',
      1 => 1775065798,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '191555955869cd5da3797663-73222960',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_69cd5da37f1a20_10223735',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_69cd5da37f1a20_10223735')) {function content_69cd5da37f1a20_10223735($_smarty_tpl) {?><?php if (!is_callable('smarty_block_wa_js')) include '/var/www/web-magaz/wa-system/vendors/smarty-plugins/block.wa_js.php';
...
"></i><?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['state']->value->getName(), ENT_QUOTES, 'UTF-8', true);?>
...
?>
                    <li data-courier-id="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['courier']->value['id'], ENT_QUOTES, 'UTF-8', true);?>
" class="list">
...
/">
                            ...
                            <?php }?>
                            <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['courier']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
...
" data-sales-channel="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['channel_id']->value, ENT_QUOTES, 'UTF-8', true);?>
" class="list">
...
"><?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['channel']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
</a>
                    </li>
                <?php } ?>
            </ul>

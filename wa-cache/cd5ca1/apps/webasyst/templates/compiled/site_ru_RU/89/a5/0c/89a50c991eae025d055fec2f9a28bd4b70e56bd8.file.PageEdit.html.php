<?php /* Smarty version Smarty-3.1.14, created on 2026-04-01 18:04:50
         compiled from "/var/www/web-magaz/wa-system/page/templates-legacy/PageEdit.html" */ ?>
<?php /*%%SmartyHeaderCode:60345644069cd5e425609f9-43488764%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '89a50c991eae025d055fec2f9a28bd4b70e56bd8' => 
    array (
      0 => '/var/www/web-magaz/wa-system/page/templates-legacy/PageEdit.html',
      1 => 1775065832,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '60345644069cd5e425609f9-43488764',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_69cd5e426424f2_73397265',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_69cd5e426424f2_73397265')) {function content_69cd5e426424f2_73397265($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_wa_datetime')) include '/var/www/web-magaz/wa-system/vendors/smarty-plugins/modifier.wa_datetime.php';
...
<?php }?>" title="Предпросмотр" target="_blank"><?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['url_decoded']->value, ENT_QUOTES, 'UTF-8', true);?>
<?php echo $_smarty_tpl->tpl_vars['page']->value['url'];?>
</a>
                        <a href="<?php echo $_smarty_tpl->tpl_vars['url']->value;?>
<?php echo $_smarty_tpl->tpl_vars['page']->value['url'];?>
            ...
            <div class="fields form">
                <div class="field-group">
                    <div class="field">
                        ...
                        <div class="value">
                            <input type="text" class="bold large long" name="info[name]" value="<?php if ($_smarty_tpl->tpl_vars['page']->value){?><?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['page']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
<?php }?>" />
                        </div>
                    </div>
                    <div class="field">
...
<?php }?><input type="text" name="info[url]" class="bold" value="<?php if ($_smarty_tpl->tpl_vars['page']->value){?><?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['page']->value['url'], ENT_QUOTES, 'UTF-8', true);?>
<?php }?>" />
                        </div>
...
" /></div>
                    ...
                    <div class="field-group og-group" <?php if (empty($_smarty_tpl->tpl_vars['og_params']->value)){?>style="display: none;"<?php }?>>
                        <div class="field">
                            ...
                            <div class="value">
                                <input name="og[title]" class="long bold" value="<?php echo htmlspecialchars((string)ifset($_smarty_tpl->tpl_vars['og_params']->value['title'],''), ENT_QUOTES, 'UTF-8', true);?>
" <?php if (empty($_smarty_tpl->tpl_vars['og_params']->value)){?>disabled<?php }?>>
                        ...
                        <div class="field">
                            ...
                            <div class="value">
                                <input name="og[image]" class="long" value="<?php echo htmlspecialchars((string)ifset($_smarty_tpl->tpl_vars['og_params']->value['image'],''), ENT_QUOTES, 'UTF-8', true);?>
" <?php if (empty($_smarty_tpl->tpl_vars['og_params']->value)){?>disabled<?php }?>>
                                <br>
                        ...
                        <div class="field">
                            ...
                            <div class="value">
                                <input name="og[video]" class="long" value="<?php echo htmlspecialchars((string)ifset($_smarty_tpl->tpl_vars['og_params']->value['video'],''), ENT_QUOTES, 'UTF-8', true);?>
" <?php if (empty($_smarty_tpl->tpl_vars['og_params']->value)){?>disabled<?php }?>>
                            </div>
                        </div>
                        <div class="field">

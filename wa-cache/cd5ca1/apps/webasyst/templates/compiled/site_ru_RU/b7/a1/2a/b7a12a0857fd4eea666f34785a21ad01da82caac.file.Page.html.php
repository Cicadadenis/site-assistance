<?php /* Smarty version Smarty-3.1.14, created on 2026-04-01 18:04:50
         compiled from "/var/www/web-magaz/wa-system/page/templates-legacy/Page.html" */ ?>
<?php /*%%SmartyHeaderCode:131154910669cd5e42424a59-33822341%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b7a12a0857fd4eea666f34785a21ad01da82caac' => 
    array (
      0 => '/var/www/web-magaz/wa-system/page/templates-legacy/Page.html',
      1 => 1775065832,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '131154910669cd5e42424a59-33822341',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_69cd5e42465078_85379686',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_69cd5e42465078_85379686')) {function content_69cd5e42465078_85379686($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/var/www/web-magaz/wa-system/vendors/smarty3/plugins/modifier.truncate.php';
?><?php if ($_smarty_tpl->tpl_vars['ibutton']->value){?>
<link href="<?php echo $_smarty_tpl->tpl_vars['wa_url']->value;?>
wa-content/js/jquery-plugins/ibutton/jquery.ibutton.min.css?v<?php echo $_smarty_tpl->tpl_vars['wa']->value->version(true);?>
...
?>
            ...
            <div class="block block-pages">
                <h4 class="heading">
                    <span class="count"><span style="display: none;"></span><i <?php if (!$_smarty_tpl->tpl_vars['r']->value){?>style="display:none" <?php }?>class="icon16 add wa-page-add no-parent"></i></span>
                    <i class="icon16 darr"></i> <?php if ($_smarty_tpl->tpl_vars['r']->value){?><?php echo smarty_modifier_truncate(htmlspecialchars((string)str_replace('www.','',$_smarty_tpl->tpl_vars['route']->value['url_decoded']), ENT_QUOTES, 'UTF-8', true),23,'...',false,true);?>
            ...
            <div id="wa-page-settle-dialog" style="display: none;">
                <form method="post" action="?module=pages&action=settle">
                    <div class="dialog-content">
                        <p>Эти страницы не прикреплены ни к одному правилу в структуре сайта и поэтому не видны на сайте. Чтобы опубликовать их сейчас, выберите правило в структуре сайта, к которому нужно прикрепить неопубликованные страницы:</p>
                        <select>
                            <option value=""></option>
                            <?php  $_smarty_tpl->tpl_vars['route'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['route']->_loop = false;
 $_smarty_tpl->tpl_vars['r'] = new Smarty_Variable;
        ...
        $(".block-pages ul").on('click', 'li a.wa-page-link', function (e) {
            ...
            if (p.attr('id')) {
                ...
                <?php if ($_smarty_tpl->tpl_vars['options']->value['is_ajax']){?>
                    var new_hash = <?php echo json_encode($_smarty_tpl->tpl_vars['page_url']->value);?>
 + id;

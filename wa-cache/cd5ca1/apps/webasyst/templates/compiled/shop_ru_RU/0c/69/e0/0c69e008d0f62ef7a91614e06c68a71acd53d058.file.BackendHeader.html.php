<?php /* Smarty version Smarty-3.1.14, created on 2026-04-01 17:57:54
         compiled from "/var/www/web-magaz/wa-system/webasyst/templates/actions/backend/BackendHeader.html" */ ?>
<?php /*%%SmartyHeaderCode:67480301969cd5ca246b7c9-00411692%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0c69e008d0f62ef7a91614e06c68a71acd53d058' => 
    array (
      0 => '/var/www/web-magaz/wa-system/webasyst/templates/actions/backend/BackendHeader.html',
      1 => 1775065830,
      2 => 'file',
    ),
    '340a3ce58d2b9b2c5118a3b1cec745d251ba4e2d' => 
    array (
      0 => '/var/www/web-magaz/wa-system/webasyst/templates/actions/backend/BackendLogo.inc.html',
      1 => 1775065831,
      2 => 'file',
    ),
    '811e65450043cb0bdffe323e518d39e3bb1f9920' => 
    array (
      0 => '/var/www/web-magaz/wa-system/webasyst/templates/actions/dashboard/DashboardAnnouncement.html',
      1 => 1775065831,
      2 => 'file',
    ),
    '2ff6b085550049a9200eb46da0355e77e08e6c7f' => 
    array (
      0 => '/var/www/web-magaz/wa-system/webasyst/templates/actions/backend/BackendHeader20.html',
      1 => 1775065831,
      2 => 'file',
    ),
    '2840db41dd68506db34296cbe5377bdde0e2944a' => 
    array (
      0 => '/var/www/web-magaz/wa-system/webasyst/templates/actions/backend/BackendHeader13.html',
      1 => 1775065830,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '67480301969cd5ca246b7c9-00411692',
  'function' => 
  array (
    '_renderHeaderItem' => 
    array (
  ...
  'unifunc' => 'content_69cd5ca2555f48_87758774',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_69cd5ca2555f48_87758774')) {function content_69cd5ca2555f48_87758774($_smarty_tpl) {?><div id="wa-nav">
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("./BackendHeader20.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '67480301969cd5ca246b7c9-00411692');
content_69cd5ca246eae8_42784767($_smarty_tpl);
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("./BackendHeader13.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '67480301969cd5ca246b7c9-00411692');
content_69cd5ca2504b12_70161049($_smarty_tpl);
...
<?php }?>
<?php }} ?><?php /* Smarty version Smarty-3.1.14, created on 2026-04-01 17:57:54
         compiled from "/var/www/web-magaz/wa-system/webasyst/templates/actions/backend/BackendHeader20.html" */ ?>
<?php if ($_valid && !is_callable('content_69cd5ca246eae8_42784767')) {function content_69cd5ca246eae8_42784767($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/var/www/web-magaz/wa-system/vendors/smarty3/plugins/modifier.truncate.php';
if (!is_callable('smarty_modifier_regex_replace')) include '/var/www/web-magaz/wa-system/vendors/smarty3/plugins/modifier.regex_replace.php';
?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("./BackendLogo.inc.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('backend_url'=>$_smarty_tpl->tpl_vars['backend_url']->value,'company_name'=>$_smarty_tpl->tpl_vars['company_name']->value,'position'=>"header"), 0, '67480301969cd5ca246b7c9-00411692');
content_69cd5ca2490792_04609509($_smarty_tpl);
...
<?php } ?></div><?php }?><?php if ($_smarty_tpl->tpl_vars['request_uri']->value==$_smarty_tpl->tpl_vars['backend_url']->value||$_smarty_tpl->tpl_vars['request_uri']->value==((string)$_smarty_tpl->tpl_vars['backend_url']->value)."/"||$_smarty_tpl->tpl_vars['is_dashboards']->value){?><?php }else{ ?><a class="wa-toggle-apps rotate180 js-toggle-apps" href="#" title="Все приложения"><i class="fas fa-th fa-lg"></i></a><?php }?><?php if ($_smarty_tpl->tpl_vars['request_uri']->value==$_smarty_tpl->tpl_vars['backend_url']->value||$_smarty_tpl->tpl_vars['request_uri']->value==((string)$_smarty_tpl->tpl_vars['backend_url']->value)."/"||$_smarty_tpl->tpl_vars['is_dashboard']->value){?><?php if ($_smarty_tpl->tpl_vars['wa']->value->user()->getRights('installer','backend')){?><a href="<?php echo $_smarty_tpl->tpl_vars['backend_url']->value;?>
installer/store/?filters[type]=app"class="button light-gray rounded nowrap"><i class="fas fa-plus-circle"></i> <span>Приложения</span></a><?php }?><div class="dashboard-customize"><a href="javascript:void(0);"class="button nobutton rounded nowrap gray js-dashboard-edit"data-current_dashboard-id="<?php echo smarty_modifier_regex_replace((($tmp = @$_smarty_tpl->tpl_vars['selected_sidebar_item']->value)===null||$tmp==='' ? 0 : $tmp),'/[^0-9]/','');?>
"id="show-dashboard-editable-mode_"><i class="fas fa-sliders-h"></i> <span>Виджеты</span></a><a href="javascript:void(0);"class="button js-dashboard-edit-close"style="display: none;"><span>Готово</span></a></div><?php }?><div class="dropdown" id="wa-notifications-dropdown"><button class="icon large wa-notifications-bell dropdown-toggle without-arrow js-notifications-bell" title="Уведомления"><i class="fas fa-bell"></i><?php if (!empty($_smarty_tpl->tpl_vars['notifications']->value)){?><span class="badge"><?php echo count($_smarty_tpl->tpl_vars['notifications']->value);?>
</span><?php }?></button><?php /*  Call merged included template "../dashboard/DashboardAnnouncement.html" */
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("../dashboard/DashboardAnnouncement.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('notifications'=>$_smarty_tpl->tpl_vars['notifications']->value), 0, '67480301969cd5ca246b7c9-00411692');
content_69cd5ca24d46a2_29546564($_smarty_tpl);
...
<?php }} ?><?php /* Smarty version Smarty-3.1.14, created on 2026-04-01 17:57:54
         compiled from "/var/www/web-magaz/wa-system/webasyst/templates/actions/backend/BackendLogo.inc.html" */ ?>
<?php if ($_valid && !is_callable('content_69cd5ca2490792_04609509')) {function content_69cd5ca2490792_04609509($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/var/www/web-magaz/wa-system/vendors/smarty3/plugins/modifier.truncate.php';
...
"></a></div><?php }?>
<?php }} ?><?php /* Smarty version Smarty-3.1.14, created on 2026-04-01 17:57:54
         compiled from "/var/www/web-magaz/wa-system/webasyst/templates/actions/dashboard/DashboardAnnouncement.html" */ ?>
<?php if ($_valid && !is_callable('content_69cd5ca24d46a2_29546564')) {function content_69cd5ca24d46a2_29546564($_smarty_tpl) {?><div class="alert-fixed-box large hidden d-notification-wrapper js-notification-wrapper" id="d-notification-wrapper">
...
?>
            <div class="alert wa-notification js-wa-announcement" data-id="<?php echo $_smarty_tpl->tpl_vars['n']->value['id'];?>
">
                <div class="wa-notification-header wa-gradient-overlay-medium">
                    <div class="flexbox middle space-8">
                        <?php $_smarty_tpl->tpl_vars['_info'] = new Smarty_variable($_smarty_tpl->tpl_vars['n']->value['app'], null, 0);?>
                        ...
                        <i class="icon size-20" style="background: url('<?php echo $_smarty_tpl->tpl_vars['root_url']->value;?>
<?php if (!empty($_smarty_tpl->tpl_vars['_info']->value['icon'][24])){?><?php echo $_smarty_tpl->tpl_vars['_info']->value['icon'][24];?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['_info']->value['img'];?>
<?php }?><?php echo $_smarty_tpl->tpl_vars['_version']->value;?>
'); background-size: 20px 20px;"></i>
                        <strong class="nowrap uppercase wide"><?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['_info']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
</strong>
                        <span class="nowrap"><?php echo waDateTime::format('humandatetime',$_smarty_tpl->tpl_vars['n']->value['datetime']);?>
</span>
                        <a href="javascript:void(0);" class="alert-close js-announcement-hide" title="Закрыть"><i class="fas fa-times"></i></a>
                    </div>
                </div>
                ...
                <?php if ($_smarty_tpl->tpl_vars['n']->value['app_id']!=='installer'){?>
                    <a data-app-id="<?php echo $_smarty_tpl->tpl_vars['n']->value['app_id'];?>
" href="javascript:void(0);" class="custom-ml-16 custom-py-4 hint js-announcement-close flexbox" title="Закрыть">Пометить как прочитанное</a>
                <?php }?>
            </div>
        <?php } ?>
    <?php }else{ ?>
...
<?php }} ?><?php /* Smarty version Smarty-3.1.14, created on 2026-04-01 17:57:54
         compiled from "/var/www/web-magaz/wa-system/webasyst/templates/actions/backend/BackendHeader13.html" */ ?>
<?php if ($_valid && !is_callable('content_69cd5ca2504b12_70161049')) {function content_69cd5ca2504b12_70161049($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/var/www/web-magaz/wa-system/vendors/smarty3/plugins/modifier.truncate.php';
?>
<?php if (!function_exists('smarty_template_function__renderHeaderItem')) {
    function smarty_template_function__renderHeaderItem($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;

<?php /* Smarty version Smarty-3.1.14, created on 2026-04-01 18:05:16
         compiled from "/var/www/web-magaz/wa-apps/site/templates/actions-legacy/settings/Settings.html" */ ?>
<?php /*%%SmartyHeaderCode:182296886369cd5e5cb0edf1-10303042%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1bfa7bcb53e8476f615913d1fe919abdcbb36f24' => 
    array (
      0 => '/var/www/web-magaz/wa-apps/site/templates/actions-legacy/settings/Settings.html',
      1 => 1775065754,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '182296886369cd5e5cb0edf1-10303042',
  'function' => 
  array (
    '_renderCdnItem' => 
    array (
  ...
  'unifunc' => 'content_69cd5e5cb625c4_54937670',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_69cd5e5cb625c4_54937670')) {function content_69cd5e5cb625c4_54937670($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_join')) include '/var/www/web-magaz/wa-system/vendors/smarty-plugins/modifier.join.php';
...
<?php if (!function_exists('smarty_template_function__renderRobotsControl')) {
    ...
    <div class="field">
        ...
        <div class="value">
            <textarea name="robots"><?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['robots']->value, ENT_QUOTES, 'UTF-8', true);?>
</textarea>
            <br />
...
" enctype="multipart/form-data">
            ...
            <div class="field-group">
                <div class="field">
                    ...
                    <div class="value">
                        <strong>http://</strong><input type="text" class="bold" name="url" value="<?php echo waIdna::dec(htmlspecialchars((string)$_smarty_tpl->tpl_vars['domain']->value, ENT_QUOTES, 'UTF-8', true));?>
" /><br />
                        <span class="hint">
                ...
                <div class="field">
                    ...
                    <div class="value no-shift">
                        ...
                        <div <?php if (!$_smarty_tpl->tpl_vars['title']->value){?>style="display:none"<?php }?>>
                            <input type="text" class="bold" name="title" value="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['title']->value, ENT_QUOTES, 'UTF-8', true);?>
" /><br />
...
' + c + ')');
                ...
                <div class="field">
                    ...
                    <div class="value">
                        ...
                        <input type="text" name="google_analytics[code]" value="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['google_analytics']->value['code'], ENT_QUOTES, 'UTF-8', true);?>
">
                        &nbsp;
                        <label class="small">
                    ...
                    <div class="value no-shift">
                        ...
                        <textarea name="head_js" placeholder="&lt;script&gt;&lt;/script&gt;"><?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['head_js']->value, ENT_QUOTES, 'UTF-8', true);?>
</textarea><br />
                        <span class="hint">
                            &lt;/head&gt;
                        </span>

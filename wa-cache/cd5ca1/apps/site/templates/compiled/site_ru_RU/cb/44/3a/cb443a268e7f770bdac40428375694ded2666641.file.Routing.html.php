<?php /* Smarty version Smarty-3.1.14, created on 2026-04-01 18:05:53
         compiled from "/var/www/web-magaz/wa-apps/site/templates/actions-legacy/routing/Routing.html" */ ?>
<?php /*%%SmartyHeaderCode:38262374969cd5e810753b3-22715957%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cb443a268e7f770bdac40428375694ded2666641' => 
    array (
      0 => '/var/www/web-magaz/wa-apps/site/templates/actions-legacy/routing/Routing.html',
      1 => 1775065754,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '38262374969cd5e810753b3-22715957',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_69cd5e81095d72_15798259',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_69cd5e81095d72_15798259')) {function content_69cd5e81095d72_15798259($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/var/www/web-magaz/wa-system/vendors/smarty3/plugins/modifier.truncate.php';
?><div class="content">
...
<?php }?></span>
            <span class="errormsg" id="incorrect-install-error" style="margin: 1em 0;"><?php if (!empty($_smarty_tpl->tpl_vars['routing_errors']->value['incorrect'])){?><?php echo nl2br(htmlspecialchars((string)$_smarty_tpl->tpl_vars['routing_errors']->value['incorrect'], ENT_QUOTES, 'UTF-8', true));?>
<?php }?></span>
        </div>
        <div>
...
img/script-code.png?v=1" class="s-app24x24icon-menu-v" alt=""><span class="text"><?php echo htmlspecialchars((string)smarty_modifier_truncate((($tmp = @$_smarty_tpl->tpl_vars['route']->value['text'])===null||$tmp==='' ? '' : $tmp),32), ENT_QUOTES, 'UTF-8', true);?>
</span>
                                <?php }else{ ?>
